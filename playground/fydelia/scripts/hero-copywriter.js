/* ==========================================================
   FYDELIA — HERO ANIMATION (COPYWRITER VERSION)
   Live WiFi login page generation inside the phone mockup.
...
(function() {
  ...
  const brandPresets = [
    ...
    { match: /./, name: null, tag: 'GUEST WIFI · FREE', initial: null, accent: '#FF2B2B', bg: 'linear-gradient(180deg, #1a0808, #0a0a0c)', headline: 'Welcome in.<br>Free WiFi, just for you.' },
  ];
